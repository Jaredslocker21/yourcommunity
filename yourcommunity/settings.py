"""
Django settings for yourcommunity project.
...
ALLOWED_HOSTS = ["yourcommunityblog.herokuapp.com", "localhost"]
...
ROOT_URLCONF = 'yourcommunity.urls'
...
WSGI_APPLICATION = 'yourcommunity.wsgi.application'
...
SUMMERNOTE_CONFIG = {
    # You can set it to `False` to use SummernoteInplaceWidget by default
